...
[![Support me on Ko-fi](assets/support_me_on_kofi_blue.png)](https://ko-fi.com/yeahnoforsure_)
...
- Optionally request original, pre-badge images from [JellyTag-Plus](https://github.com/nothing2obvi/jellyfin-plugins/tree/main/Jellytag) using `jellytag=off`  
...
2. Fill in:  
   ...
   - **JellyTag-Plus** – enable this if your [JellyTag-Plus](https://github.com/nothing2obvi/jellyfin-plugins/tree/main/Jellytag) instance supports `jellytag=off` and you want Pixelfin to use original images without rendered badges  
